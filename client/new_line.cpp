...
{
    if (str.find(strCR) == std::string::npos)
        return LF;
    else if (str.find(strLF) == std::string::npos)
        return CR;
    else
        return CRLF;
}
...
std::string replace(const std::string &src, const std::string &tar, const std::string &res)
{
