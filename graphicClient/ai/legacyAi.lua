...
consts = {
	["findPersonTimerId"] = 1,
	["findPersonTimeout"] = 60000,
	
	["timeoutTimerId"] = 2,
	["timeoutTimeout"] = 150000,
...
sendingstep = function()
	me:debugOutput("sendingstep" .. data.sendingStep)
	local timer = consts.typeDelay
	...
	elseif data.sendingStep == 4 then
		me:animateSend(generateRandom(consts.clickDelay))
		data.sendingStep = 0
		timer = consts.thinkdelay
	end
...
timeout = function(timerid)
	me:debugOutput("Timeout!!" .. timerid)
